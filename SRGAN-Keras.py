...
class SRGAN():
    ...
    def __init__(self, 
        ...
        loss_weights=[1e-3, 0.006],     # gan, percept, [pixel(2e-3)]
        training_mode=True,
        refer_model=None, 
    ):
        """        
...
if __name__ == '__main__':
    ...
    SRResnet = SRGAN(training_mode=False)
    SRResnet.generator.load_weights('./data/weights/DIV2K_generator.h5')
    # sr.load_weights('./DIV2K_generator_4X_epoch71500.h5')
    gan = SRGAN(gen_lr=1e-4, dis_lr=1e-4,
                height_lr=48, width_lr=48,
                refer_model=SRResnet.generator)
    ...
    gan.load_weights('./data/weights/srgan_mri/SRGAN_generator_4X_epoch40000.h5',
    #                  None,)
                     './data/weights/srgan_mri/SRGAN_discriminator_4X_epoch40000.h5')
