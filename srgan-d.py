...
sys.stderr = stderr
from libs.vgg19_noAct import VGG19
...
class SRGAN():
    ...
    def __init__(self, 
        ...
        loss_weights=[5e-3, 0.001],     # gan, percept, [pixel(2e-3)]
        training_mode=True,
        refer_model=None, 
    ):
        """        
        ...
        self.generator = self.build_RRDB()
    ...
    def train_srgan(self, 
        ...
        log_weight_path='./data/weights/doctor_gan_mri_vgg/',
        log_tensorboard_path='./data/logs/',
        log_tensorboard_name='SRGAN-D',
        log_tensorboard_update_freq=1000,
        log_test_frequency=1000,
        log_test_path="./images/samples-d-mri-vgg/",
    ):
...
if __name__ == '__main__':
    ...
    RDDB.generator.load_weights('./data/weights/Doctor_gan.h5')
    # sr.load_weights('./DIV2K_generator_4X_epoch71500.h5')
    gan = SRGAN(gen_lr=1.25e-5, dis_lr=1.25e-5,
    ...
    gan.load_weights('./data/weights/doctor_gan_mri/Doctor_generator_4X_epoch60000.h5',
                     './data/weights/doctor_gan_mri/Doctor_discriminator_4X_epoch60000.h5')
    ...
    gan.train_srgan(
        ...
        batch_size=16,
        dataname='Doctor',
        datapath_train=r'C:\DeepLearning\datasets\MRI',
        # datapath_validation='./images/DIV2K_valid_HR/',
        datapath_test='./images/val_dir_mri/',
